...
public class Graph {
	...
	/*
	 * This method adds a new edge to the graph (weighted).
	...
	public boolean insertEdge(int x, int y, int weight, boolean undirected) {
		...
		if(x < 1 || x > numVertices 
				|| y < 1 || y > numVertices) return false;
        ...
        if(undirected) {
        	...
        	//If the graph is undirected, insert also the edge (y,x)
